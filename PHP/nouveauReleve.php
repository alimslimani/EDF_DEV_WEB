...
<body>
    <?php
        ...
        echo '<input type="button" value="Retour" background-color ="royalblue"  onclick="history.go(-1)">';
        echo "<br>";
        $sql = $cnx->prepare("
        ...
        echo "<input type='number' name ='value' id='value' min='$line[3]'></input>";
        ...
        echo "<br>";
        echo"<input type='submit' value='Inserer'/>";
        echo"</form>";
